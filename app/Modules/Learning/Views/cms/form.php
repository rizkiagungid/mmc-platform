...
<style>
    ...
    [data-bs-theme="dark"] .ck.ck-labeled-field-view__input-wrapper input {
        color: #ffffff !important;
    }
</style>
...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        <h4 class="text-body font-heading m-0 fw-bold">
    ...
    <a href="<?= base_url('admin/learning') ?>" class="btn btn-saas-dark text-body border border-secondary border-opacity-50 btn-sm">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="saas-card p-4 mb-4 border border-secondary border-opacity-25">
                <div class="mb-3">
                    <label class="form-label text-body small fw-bold">Judul Materi Pembelajaran <span class="text-danger">*</span></label>
                    <input type="text" name="title" id="materialTitle" class="form-control form-control-lg bg-body-secondary text-body border-secondary border-opacity-50" placeholder="Contoh: Fundamental Python & Structuring Code untuk Pemula" value="<?= esc($material['title'] ?? '') ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label text-secondary small fw-bold">Slug URL SEO Friendly</label>
                    <div class="input-group input-group-sm">
                        <span class="input-group-text bg-body-secondary text-secondary border-secondary border-opacity-50 font-monospace"><?= base_url('materi') ?>/</span>
                        <input type="text" name="slug" id="materialSlug" class="form-control bg-body-secondary text-body border-secondary border-opacity-50 font-monospace" placeholder="python-dasar-pemula" value="<?= esc($material['slug'] ?? '') ?>">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="excerpt" class="form-control bg-body-secondary text-body border-secondary border-opacity-50" rows="3" placeholder="Ringkasan 2-3 kalimat mengenai poin utama yang dipelajari pada materi ini..." required><?= esc($material['excerpt'] ?? '') ?></textarea>
                </div>

                <div class="mb-3">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <label class="form-label text-body small fw-bold mb-0">Isi Konten Materi Lengkap (Rich Text Content) <span class="text-danger">*</span></label>
        ...
        <div class="col-lg-4">
            ...
            <div class="saas-card p-4 mb-4 border border-secondary border-opacity-25">
                <h6 class="text-body font-heading fw-bold mb-3 border-bottom border-secondary border-opacity-25 pb-2">
                ...
                <div class="mb-3">
                    ...
                    <select name="status" id="statusSelect" class="form-select bg-body-secondary text-body border-secondary border-opacity-50">
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" name="published_at" class="form-control bg-body-secondary text-body border-secondary border-opacity-50 font-monospace" value="<?= !empty($material['published_at']) ? date('Y-m-d\TH:i', strtotime($material['published_at'])) : '' ?>">
                ...
                <div class="mb-3">
                    ...
                    <div class="p-2 rounded-2 bg-body-secondary border border-secondary border-opacity-50">
                        <div class="form-check mb-1">
                            ...
                            <label class="form-check-label text-body small" for="visPublic">
            ...
            <div class="saas-card p-4 border border-secondary border-opacity-25">
                ...
                <div class="mb-3">
                    ...
                    <select name="category" class="form-select bg-body-secondary text-body border-secondary border-opacity-50">
                ...
                <div class="mb-3">
                    ...
                    <select name="division_id" class="form-select bg-body-secondary text-body border-secondary border-opacity-50">
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" name="tags" class="form-control bg-body-secondary text-body border-secondary border-opacity-50" placeholder="python, dasar, backend, web" value="<?= esc($tagString) ?>">
                </div>

                <div class="mb-3">
                    <label class="form-label text-secondary small fw-medium">Thumbnail Card Image</label>
                    <input type="file" name="thumbnail_file" class="form-control form-control-sm bg-body-secondary text-body border-secondary border-opacity-50 mb-1" accept="image/*">
                    <input type="text" name="thumbnail" id="thumbnailUrl" class="form-control form-control-sm bg-body-secondary text-body border-secondary border-opacity-50 font-monospace" placeholder="Atau paste URL / Media Library..." value="<?= esc($material['thumbnail'] ?? '') ?>">
                </div>

                <div class="mb-3">
                    <label class="form-label text-secondary small fw-medium">Banner Header Image (Opsional)</label>
                    <input type="file" name="banner_file" class="form-control form-control-sm bg-body-secondary text-body border-secondary border-opacity-50 mb-1" accept="image/*">
                    <input type="text" name="banner" id="bannerUrl" class="form-control form-control-sm bg-body-secondary text-body border-secondary border-opacity-50 font-monospace" placeholder="Atau paste URL / Media Library..." value="<?= esc($material['banner'] ?? '') ?>">
                </div>

                <!-- Material Downloadable Attachments Section -->
                <div class="mb-3 pt-3 border-top border-secondary border-opacity-25">
                    <label class="form-label text-body small fw-bold mb-1"><i class="fa-solid fa-paperclip text-warning me-1"></i> Lampiran File Terlampir (Attachments)</label>
                    ...
                    <div id="attachmentsWrapper">
                        <?php foreach ($existingAttachments as $idx => $att): ?>
                            <div class="p-2 rounded-2 bg-body-secondary border border-secondary border-opacity-50 mb-2 attachment-row">
                                <div class="row g-2">
                                    <div class="col-7">
                                        <input type="text" name="attachments[<?= $idx ?>][name]" class="form-control form-control-sm bg-body text-body border-secondary border-opacity-50" placeholder="Nama File (Contoh: Modul_Python.pdf)" value="<?= esc($att['name'] ?? '') ?>">
                                    </div>
                                    <div class="col-5">
                                        <select name="attachments[<?= $idx ?>][type]" class="form-select form-select-sm bg-body text-body border-secondary border-opacity-50 style-tiny font-monospace">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="attachments[<?= $idx ?>][url]" class="form-control form-control-sm bg-body text-body border-secondary border-opacity-50 font-monospace style-tiny" placeholder="URL File / uploads/..." value="<?= esc($att['url'] ?? '') ?>">
                                    </div>
...
<div class="modal fade" id="mediaLibraryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content bg-body text-body border border-secondary border-opacity-25">
                ...
                <div class="row g-3">
                    <?php foreach ($mediaList as $m): ?>
                        <div class="col-6 col-md-3 col-lg-2">
                            <div class="p-2 rounded-3 bg-body-secondary border border-secondary border-opacity-25 text-center cursor-pointer media-item-card" onclick="selectMediaUrl('<?= esc($m['file_path']) ?>')">
                                <img src="<?= esc($m['file_path']) ?>" alt="<?= esc($m['original_name']) ?>" class="w-100 object-fit-cover rounded-2 mb-2" style="height: 100px;">
                                <div class="text-body style-tiny text-truncate"><?= esc($m['original_name']) ?></div>
            ...
            <div class="modal-footer border-top border-secondary border-opacity-25">
                <button type="button" class="btn btn-saas-dark text-body border border-secondary border-opacity-50" data-bs-dismiss="modal">Tutup</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function addAttachmentRow() {
        ...
        div.className = 'p-2 rounded-2 bg-body-secondary border border-secondary border-opacity-50 mb-2 attachment-row';
        div.innerHTML = `
            <div class="row g-2">
                <div class="col-7">
                    <input type="text" name="attachments[${attachmentIndex}][name]" class="form-control form-control-sm bg-body text-body border-secondary border-opacity-50" placeholder="Nama File (Contoh: Modul_Python.pdf)">
                </div>
                <div class="col-5">
                    <select name="attachments[${attachmentIndex}][type]" class="form-select form-select-sm bg-body text-body border-secondary border-opacity-50 style-tiny font-monospace">
                        <optgroup label="File Unduhan">
                ...
                <div class="col-10">
                    <input type="text" name="attachments[${attachmentIndex}][url]" class="form-control form-control-sm bg-body text-body border-secondary border-opacity-50 font-monospace style-tiny" placeholder="URL File / uploads/...">
                </div>
                <div class="col-2 text-end">
                    <button type="button" class="btn btn-sm btn-outline-danger w-100 py-1" onclick="this.closest('.attachment-row').remove()"><i class="fa-solid fa-trash"></i></button>
                </div>
