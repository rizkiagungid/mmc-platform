...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        <h4 class="text-body font-heading m-0 fw-bold"><i class="fa-solid fa-book-bookmark text-danger me-2"></i> Materi Pembelajaran — Portal Anggota</h4>
        <p class="text-secondary small m-0">Akses seluruh modul kurikulum pelatihan, panduan teknis, dan tutorial eksklusif MMC</p>
    </div>
    <a href="<?= base_url('materi') ?>" target="_blank" class="btn btn-sm btn-saas-dark text-body border border-secondary border-opacity-50 style-tiny">
    ...
    <form action="<?= base_url('member/learning') ?>" method="GET" class="row g-2 align-items-center">
        <div class="col-md-5">
            <div class="input-group input-group-sm">
                ...
                <input type="text" name="q" class="form-control bg-body-secondary text-body border-secondary border-opacity-50" placeholder="Cari judul, topik, atau isi materi..." value="<?= esc($filters['search'] ?? '') ?>">
            </div>
        </div>
        <div class="col-md-3">
            <select name="div" class="form-select form-select-sm bg-body-secondary text-body border-secondary border-opacity-50">
        ...
        <div class="col-md-2">
            <select name="cat" class="form-select form-select-sm bg-body-secondary text-body border-secondary border-opacity-50">
        ...
        <div class="col-md-2 d-flex gap-1">
            ...
            <a href="<?= base_url('member/learning') ?>" class="btn btn-sm btn-saas-dark text-body border border-secondary border-opacity-50">Reset</a>
        </div>
    </form>
</div>
...
<div class="row g-4">
    <?php if (empty($materials)): ?>
        <div class="col-12 text-center py-5 text-secondary saas-card border border-secondary border-opacity-25">
    ...
    <?php foreach ($materials as $m): ?>
        <div class="col-md-6 col-lg-4">
            <div class="saas-card saas-card-glow h-100 d-flex flex-column justify-content-between overflow-hidden border border-secondary border-opacity-25">
                <div>
                    <div class="position-relative bg-body-secondary overflow-hidden" style="height: 170px;">
                    ...
                    <div class="p-4">
                        ...
                        <h6 class="text-body font-heading mb-2 fw-bold">
                            <a href="<?= base_url('member/learning/' . $m['slug']) ?>" class="text-body text-decoration-none hover-danger"><?= esc($m['title']) ?></a>
                        </h6>
