...
<div class="saas-card p-4 col-lg-8">
    ...
    <form action="<?= base_url('admin/meetings/store') ?>" method="POST">
        ...
        <div class="row g-3">
            <div class="col-md-12">
                <label class="form-label text-secondary small fw-medium">Judul Pertemuan / Workshop</label>
                <input type="text" name="title" class="form-control" placeholder="Contoh: Workshop Editing Premiere Pro" value="<?= old('title') ?>" required>
            </div>

            <div class="col-md-12">
                <label class="form-label text-secondary small fw-medium">Deskripsi Kegiatan</label>
                <textarea name="description" class="form-control" rows="3" placeholder="Jelaskan topik yang akan dipelajari..."><?= old('description') ?></textarea>
            </div>

            <div class="col-md-6">
                <label class="form-label text-secondary small fw-medium">Mentor / Pemateri</label>
                <input type="text" name="mentor" class="form-control" placeholder="Contoh: Dra. Endang Setyowati / Tim BPH" value="<?= old('mentor') ?>">
            </div>
