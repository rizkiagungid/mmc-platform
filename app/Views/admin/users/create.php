    ...
    <form action="<?= base_url('admin/users/store') ?>" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nis_nip" class="form-control" value="<?= old('nis_nip') ?>">
            </div>

            <div class="col-md-6">
                <label class="form-label text-secondary small fw-medium">Kelas / Divisi</label>
                <input type="text" name="class_dept" class="form-control" value="<?= old('class_dept') ?>">
            </div>
            ...
            <div class="col-md-6">
                <label class="form-label text-secondary small fw-medium">Password Awal</label>
